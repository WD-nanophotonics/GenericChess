...
from .semantic import (
    ...
    delta_runtime_layout, delta_runtime_new, delta_runtime_pop,
...
class NativeSemanticDeltaRuntime:
    ...
    __slots__ = ("compiled", "native_rules", "_capsule", "_packer", "counters", "history_certified")

    def __init__(self, compiled, native_rules, capsule, *, history_certified: bool):
    ...
    @classmethod
    def from_position(cls, native_rules, position_capsule):
        return cls(None, native_rules, delta_runtime_new(native_rules, position_capsule), history_certified=True)
    ...
    def from_state(cls, compiled, native_rules, state, *, history_certified: bool):
        ...
        if native_rules.fingerprint != compiled.ruleset_fingerprint or not history_certified:
        ...
        runtime = cls(compiled, native_rules, delta_runtime_new(native_rules, position), history_certified=True)
