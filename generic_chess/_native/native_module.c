...
static PyObject *gc_semantic_delta_runtime_info(PyObject *self, PyObject *args) {
    ...
    GCSemanticDeltaRuntimeStack *runtime = gc_semantic_delta_runtime_from_capsule(runtime_capsule);
    if (!runtime) return NULL;
    return Py_BuildValue("{s:i,s:i,s:i,s:i,s:i,s:i}", "depth", runtime->depth, "capacity", runtime->capacity, "peak_depth", runtime->peak_depth, "peak_undo_frames", runtime->peak_depth, "capacity_grows", runtime->capacity_grows, "delta_frame_bytes", (int)sizeof(GCSemanticDeltaUndo));
}
...
static PyMethodDef gc_methods[] = {
    ...
    {"semantic_delta_runtime_new", gc_semantic_delta_runtime_new_api, METH_VARARGS,
     "semantic_delta_runtime_new(rules, position) -> mutable delta runtime capsule"},
    ...
    {"semantic_delta_runtime_snapshot", gc_semantic_delta_runtime_snapshot, METH_VARARGS,
     "semantic_delta_runtime_snapshot(runtime) -> canonical current snapshot"},
