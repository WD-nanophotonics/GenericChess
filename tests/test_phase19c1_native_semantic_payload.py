...
def test_c1_capsule_survives_python_payload_deletion(module):
    ...
    assert observed["semantic_payload_version"] == 4
...
def test_c1_single_field_mutations_fail_closed(module):
    ...
    _mutate_rejected(module, p_cannon, lambda p: p.__setitem__("semantic_payload_version", 5), "unknown version 5")
    ...
    _mutate_rejected(module, p_cannon, lambda p: p.__setitem__("repetition_limit", 0x100000000), "repetition_limit 2^32")
