...
- RESULT checkpoint: `3c8a8c95b37bd300e863a45057fbeb70e02b54b5`
- Published verification: local `HEAD` equals `origin/sandbox` at `3c8a8c95b37bd300e863a45057fbeb70e02b54b5`
...
F86R ARM-N comparison routes: V4-3 `STATIC_MATE_CONFINEMENT_DEPENDS_ON_OCCUPANCY_STRUCTURE`; V5-3 `STATIC_MATE_WITNESSES_HAVE_STRICTLY_STRONGER_NEIGHBOR_ATTACK_COVERAGE`; overall `CONFINEMENT_GAP_IS_SAMPLE_DEPENDENT`. F86R dynamic control facts were preserved: V4-3 one single-checker action with coverage 2 and two Anchor-flight breaks; V5-3 thirteen single-checker actions with coverage 0×8 and 1×5, with 24 Anchor-flight and 3 checker-capture breaking replies.

Focused test result: `5 passed`. New games, movement candidates, dynamic work beyond F86R, AlphaBeta, BFS, training, teacher search, C2, F85, and Heavy: zero. Default generator: unchanged.
