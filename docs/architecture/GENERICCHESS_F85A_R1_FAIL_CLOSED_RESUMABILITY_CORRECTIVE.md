...
## F84 lane tradeoff and authorized geometry
...
| 4 | ~49.8 min | ~7.5 CPU-h | unvalidated projection; RSS and lane scaling were not measured |

The authorized planning geometry remains two root lanes. Three- and four-lane
values are diagnostic projections only: they are not calibrated, approved, or
accepted as execution geometry. The approved-run validator rejects any plan
whose intended lane count is not two, before a teacher runner can start.
Effective games, Arena pairs, and plies remain zero. This corrective authorizes
no acquisition.
